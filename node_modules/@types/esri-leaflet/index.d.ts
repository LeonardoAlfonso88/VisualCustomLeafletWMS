...
// declare module 'leaflet' {
    export namespace esri {
        export type CallbackHandler = (error: any, metadata: any) => void;
        ...
        export type LeafletGeometry = L.Marker | L.Polygon | L.Polyline | L.LatLngExpression | L.LatLngBounds | L.GeoJSON;
        export type GeoJSONGeometry = GeoJSON.Point | GeoJSON.Polygon | GeoJSON.LineString;
        export type Geometry = LeafletGeometry | GeoJSONGeometry;
        export type SpatialReferenceExpression = number | SpatialReference;
         ...
         */
        export class BasemapLayer extends L.TileLayer {
         ...
         * The Terms of Use for Esri hosted services apply to all Leaflet applications.
         */
        export function basemapLayer(key: Basemaps, options?: BasemapLayerOptions): BasemapLayer;

        /**
         * Options for `L.esri.TiledMapLayer`
         */
        export interface TiledMapLayerOptions extends L.TileLayerOptions, LayerOptionsBase {
            /**
         ...
         */
        export class TiledMapLayer extends L.TileLayer {
         ...
         */
        export interface RasterLayerOptions extends L.ImageOverlayOptions {
            /**
         ...
         */
        export abstract class RasterLayer extends L.ImageOverlay {
            /**
         ...
         */
        export interface DynamicMapLayerOptions extends RasterLayerOptions, LayerOptionsBase {
            /**
        ...
        export class DynamicMapLayer extends RasterLayer {
            ...
            bindPopup(content: ((layer: L.Layer) => L.Content) | L.Content | L.Popup, options?: L.PopupOptions): this;
            /**
         ...
         */
        export interface FeatureLayerOptions extends LayerOptionsBase {
            /**
             ...
             */
            pointToLayer?: (feature: any, latLng: L.LatLngExpression) => void;
            /**
        ...
        export type StyleCallback = (feature: any) => any;
        ...
        export type FeatureCallbackHandler = (error?: any, featureCollection?: any, response?: any) => void;
        export type ResponseCallbackHandler = (error?: any, response?: any) => void;
         ...
         */
        export abstract class Service extends L.Evented {
            /**
         ...
         * Options for Task
         */
        export interface TaskOptions extends ServiceOptions { }
         ...
         */
        export class Task extends L.Class {
         ...
         * ArcGIS Server Services like query, find and identify.
         */
        export function task(options: TaskOptions | Service): Task;

        /**
         * Options for ImageService
         */
        export interface ImageServiceOptions extends ServiceOptions {}
         ...
         * service.
         */
        export function imageService(options: ImageServiceOptions): ImageService;

        /**
         * Options for FeatureLayerService
         */
        export interface FeatureLayerServiceOptions extends ServiceOptions { }
         ...
         */
        export class FeatureLayerService extends Service {
         ...
         * features from the service.
         */
        export function featureLayerService(options: FeatureLayerServiceOptions): FeatureLayerService;

        /**
         * Options for Query
         */
        export interface QueryOptions extends TaskOptions { }
         ...
         */
        export interface IdentifyFeaturesOptions extends ServiceOptions { }
         ...
         * chainable API for building request parameters and executing the request.
         */
        export function identifyFeatures(options: IdentifyFeaturesOptions | ImageService): IdentifyFeatures;
         ...
         * building request parameters and executing find tasks.
         */
        export function find(options: FindOptions | MapService): Find;
    }
// }
