...
declare module 'leaflet' {
    namespace esri {
        ...
        /**
         * A generic class representing an image layer. This class can be extended to provide support for making requests from ArcGIS REST services.
         */
        ...
        class DynamicMapLayer extends RasterLayer {
            ...
            getLayerDefs(): any;
            /**
             * Redraws the layer with the new layer definitions. Corresponds to the layerDefs option on the API.
             */
